...
// Alert.js
export default function Alertgenerate({ onClose }) {
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="p-4 mb-4 text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800 w-96">
            ...
            <div className="mt-2 mb-4 text-sm">
              Please fillup Voice Type and presenter or upload audio and presenter
            </div>
  ...
  <button 
    onClick={() => navigate('/signin')} // wrapped with a function to navigate properly
    type="button" 
